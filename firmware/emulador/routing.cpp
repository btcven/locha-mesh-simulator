...
extern int routing_outcoming_PACKET_HELLO(std::string  id_node, packet_t packet_received);
extern int routing_incoming_PACKET_HELLO(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_NET_BYE(std::string  id_node, packet_t packet_received);
extern int routing_incoming_NET_BYE(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_NET_JOIN(std::string  id_node, packet_t packet_received);
extern int routing_incoming_NET_JOIN(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_NET_ROUTE(std::string  id_node, packet_t packet_received);
extern int routing_incoming_NET_ROUTE(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_PACKET_ACK(std::string  id_node, packet_t packet_received);
extern int routing_incoming_PACKET_ACK(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_PACKET_GOSSIP(std::string  id_node, packet_t packet_received);
extern int routing_incoming_PACKET_GOSSIP(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_PACKET_MSG(std::string  id_node, packet_t packet_received);
extern int routing_incoming_PACKET_MSG(std::string  id_node, packet_t packet_received);
extern int routing_outcoming_PACKET_TXN(std::string  id_node, packet_t packet_received);
extern int routing_incoming_PACKET_TXN(std::string  id_node, packet_t packet_received);
...
packet_t buildpacket(uint8_t max_hops, std::string from, std::string to, uint8_t sequence[2], std::string payload, packet_type_e type,uint8_t packetLength ){
...
packet_type_e convertir(std::string str)
{
...
int convert_msg_into_buffer(std::string msg_received, packet_t Buffer_packet){
  std::vector<std::string> splitted;
  char* original;
